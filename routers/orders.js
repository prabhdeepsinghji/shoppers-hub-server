...
//     const orderList = await Order.find().populate('user', 'name').sort({'dateOrdered': -1});  //sort has many features
//     if(!orderList){
...
//         { $group: { _id: null, totalsales: { $sum: 'totalPrice'}}}  //group specification must include an id
//     ])
